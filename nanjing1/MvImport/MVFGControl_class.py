...
from MvImport.MVFGDefines_const import *
from MvImport.MVFGDefines_header import *
from MvImport.MVFGErrorDefine_const import *


# Python3.8版本修改Dll加载策略, 默认不再搜索Path环境变量, 同时增加winmode参数以兼容旧版本
dllname = "MVFGControl.dll"
dllname = "MvImport\Win64_x64\MVFGControl.dll"
